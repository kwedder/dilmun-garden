 ...
 * two questions a review asks ("same thing?" and "different things?"), under
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Llama m = Llama.load(args[0], "model:bench", 2048, Llama.defaultThreads())) {
            ...
            for (Object o : pairs) {
                ...
                String s = v.judge(brief, Briefing.agree(a, b, about)), d = v.judge(brief, Briefing.differ(a, b, about));
                String result = "yes".equals(s) && "no".equals(d) ? "agree" : "no".equals(s) && "yes".equals(d) ? "disagree" : "inconsistent";
                ...
                System.out.println(String.format(Locale.ROOT, "  %-5s %-9s same=%-3s different=%-3s %-12s %s | %s",
